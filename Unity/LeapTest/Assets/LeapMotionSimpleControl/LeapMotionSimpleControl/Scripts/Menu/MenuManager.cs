			   ...
			   && toIdx >= 0 && toIdx < _listContent.Count) {
				...
				if (_counterTransition.CurrentState == Counter.CounterState.STOP) {
					...
					_counterTransition.StartTimerUpdatePercentage (0.75f, () => {
						...
						content.localPosition = new Vector3 (originalX + sign * _distanceBetween2Items, content.localPosition.y);
						...
						content.localPosition = new Vector3 (delta, content.localPosition.y);
					});
				}
			}
		}
